...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root {\n    --navy: #404258;\n    --lower_navy: #404258F3;\n    --gray: #474E68;\n    --white: #ffffff;\n    --btn_add: #de4c4a;\n    --btn_cancel: #292929;\n}\ninput:focus,\nselect:focus,\ntextarea:focus,\nbutton:focus {\n    outline: none;\n}\n\n* {\n    box-sizing: border-box;\n    margin: 0;\n    padding: 0;\n    font-family: sans-serif;\n}\n\nheader {\n    width: 100%;\n    height: 5vh;\n    background-color: var(--navy);\n    color: var(--white);\n    display: flex;\n    align-items: center;\n    padding: 20px;\n}\n\n.logo {\n    display: flex;\n    align-items: center;\n}\n\n.logo p {\n    font-size: 26px;\n}\n.logo img {\n    margin-left: 10px;\n}\n.container {\n    height: 95vh;\n    display: grid;\n    grid-template-columns: 305px 1fr;\n    grid-auto-flow: column;\n    \n}\n\n/* LEFT MENU */\n.left_menu {\n    background-color: #3e4058;\n    padding: 30px 20px;\n}\n\n.nav {\n    list-style: none;\n}\n\n.nav li{\n    margin: 10px 0;\n    font-size: 16px;\n    color: var(--white);\n    padding: 6px;\n    cursor: pointer;\n}\n\n.nav li:hover{\n    background-color: #42445e;\n    border: 3px;\n    border-radius: 5px;\n}\n\n.nav li img {\n    vertical-align: middle;\n}\n.nav li span {\n    margin-left: 4px;\n}\n\n.add-project-bar {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    font-size: 16px;\n    margin-top: 30px;\n    margin-bottom: 10px;\n    cursor: pointer;\n    color: var(--white)\n}\n.project-btns {\n    display: flex;\n    \n}\n\n.arrow {\n    height: 16px;\n    width: 16px;\n    padding-top: 2px;\n    margin: 0px 3px 0px 15px;\n}\n.arrow::before{\n    position: absolute;\n    content: '';\n    width: 10px;\n    height: 10px;\n    border-top: 2px solid #000;\n    border-left: 2px solid #000;\n    transform: rotate(-45deg);\n    transition: transform .25s;\n}\n.arrow.down::before {\n    transform: rotate(-135deg);\n    transition: transform .25s;\n}\n\n.project_menu ul {\n    list-style: none;\n    cursor: pointer;\n}\n\n.nav-project {\n    visibility: hidden;\n    opacity: 0;\n    transition: opacity 5s linear;\n} \n\n.dropdown {\n    visibility: visible;\n    cursor: none;\n    opacity: 1;\n}\n\n.nav-project li, .dropdown li{\n    margin-left: 9px;\n    color: var(--white);\n    font-size: 16px;\n    padding: 5px;\n    display: flex;\n    \n    align-items: center;\n    position: relative;\n}\n\n.project-delete {\n    position: absolute;\n    top: 0;\n    right: 0;\n    margin: 10px 5px 0 0;\n    \n    \n}\n\n.nav-project li, .dropdown li::before {\n    /* content: url(\"../assets/bullet.png\"); */\n    content: \"•\";\n    display: inline-block; \n    width: 1em;\n    font-size: 24px;\n    \n    /* background-color: aqua; */\n}\n\n.nav-project li:hover, \n.dropdown li:hover\n{\n    background-color: #42445e;\n    border: 3px;\n    border-radius: 5px;\n}\n\n.active{\n    background-color: #42445e;\n    border: 3px;\n    border-radius: 5px;\n}\n\n\n/* Project Form after on click + */\n.modal {\n    display: none;\n    position: fixed;\n    z-index: 1;\n    left: 0;\n    top: 0;\n    width: 100%;\n    height: 100%;\n    overflow: auto;\n    background-color: rgb(0, 0, 0);\n    background-color: rgb(0, 0, 0, 0.4);\n    padding-top: 60px;\n}\n\n.modal-content {\n    width: 450px;\n    margin: 5% auto 15% auto;\n    border: 1px solid #000;\n    background-color: var(--navy);\n    color: var(--white);\n    border: 10px;\n    border-radius: 10px;\n}\n\n.projectHeader {\n    font-size: 12px;\n    padding: 15px;\n}\n\n.projectContent {\n    padding: 15px;\n    display: flex;\n    flex-direction: column;\n}\n\n.projectContent span {\n    margin: 5px 0;\n}\n.inputForm, select {\n    width: calc(100% - 12px);\n    background-color: var(--navy);\n    border: 2px solid;\n    border-color:  var(--gray);\n    border-radius: 5px;\n    padding: 10px;\n    color: var(--white)\n}\n\nhr {\n    border-bottom: 1px solid var(--white);\n}\n\n.btn_container {\n    padding: 15px;\n    display: flex;\n    justify-content: end;\n    width: calc(100% - 12px);\n}\n\n.btn-cancel, .btn-submit {\n    padding: 5px 10px;\n    border: 0px;\n    border-radius: 3px;\n    color: var(--white);\n    font-weight: 600;\n    cursor: pointer;\n    \n}\n.btn-cancel {\n    background-color: var(--btn_cancel);\n    margin-right: 10px;\n}\n\n.btn-submit {\n    background-color: var(--btn_add);\n    \n}\n\n/* RIGHT CONTENT */\n.main_container {\n    background-color: var(--gray);\n    width: 100%;\n}\n\n.view_content {\n    width: 65%;\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    margin: 43px auto;\n}\n#mainHeader {\n    color: #fff;\n}\n.TaskList {\n    color: var(--white);\n    font-size: 16px;\n}\n\n.taskBox {\n    padding: 10px;\n    margin: 10px 0;\n    display: flex;\n    align-items: center;\n    border-left: 5px solid #fff;\n    font-size: 14px;\n    \n}\n\n.taskCheck input[type=\"checkbox\"]{\n    background-color: red;\n    display: block; \n    width: 30px;\n    height: 14px;   \n}\n\n.taskName {\n    flex-grow: 2;\n    margin: 0 5px;\n}\n\n.taskDueDate{\n    margin: 0 10px;\n}\n\n.taskDescription {\n    margin: 0 5px;\n}\n\n.taskEdit {\n    margin: 0 5px;\n}\n.taskRemove {\n    color: red;\n    margin: 0 10px;\n}\n\n.taskRemove:hover, .taskEdit:hover{\n    transition: 0.8s;\n    mix-blend-mode: soft-light;\n    cursor: pointer;\n}\n\n/* Task Checked */\n.checked > .taskName, .checked > .taskDueDate{\n    text-decoration: line-through;\n}\n\n.checked > .taskEdit img, .checked > .taskRemove{\n    opacity: 0.3;\n}\n\n.checked > .taskEdit img:hover, .checked > .taskRemove:hover{\n    opacity: 0.9;\n}\n\n/* Task Details */\n.taskDetailsModal {\n    display: block;\n    position: fixed;\n    z-index: 1;\n    left: 0;\n    top: 0;\n    width: 100%;\n    height: 100%;\n    overflow: auto;\n    background-color: rgb(0, 0, 0);\n    background-color: rgb(0, 0, 0, 0.4);\n    padding-top: 60px;\n}\n\n.taskDetails {\n    width: 450px;\n    margin: 15% auto 15% auto;\n    border: 1px solid #000;\n    background-color: var(--navy);\n    color: var(--white);\n    border: 10px;\n    border-radius: 10px;\n    padding: 30px;\n}\n\n.taskDetailsName {\n    margin-bottom: 10px;\n    word-wrap: break-word;\n}\n\n.taskDetailsDuedate {\n    margin: 5px 0;\n}\n\n.taskDetailsPriority {\n    margin: 5px 0;\n}\n\n.taskDetailsDescription{\n    inline-size: 150px;\n    overflow-wrap: break-word;\n}\n\n\n\n/* Inbox Content */\n.inbox {\n    color: var(--white)\n}\n\n.add_task_btn {\n    background-color: rgb(0, 0, 0, 0);\n    border: 0;\n    cursor: pointer;\n    margin: 20px 10px;\n    display: flex;\n}\n\n.add_task_btn span {\n    margin-left: 10px;\n}\n\n.weekContainer {\n    display: none;\n}\n.inboxContainer {\n    display: none;\n}\n\n.hideContainer {\n    display: none;\n}\n\n.showContainer {\n    display: block;\n}\n\n.textAreaForm {\n    width: calc(100% - 12px);\n    height: 150px;\n    background-color: var(--navy);\n    border: 2px solid;\n    border-color:  var(--gray);\n    border-radius: 5px;\n    padding: 10px;\n    color: var(--white);\n    resize: none;\n}\n\n.error {\n    width: calc(100% - 12px);\n    background-color: var(--navy);\n    border: 2px solid;\n    border-color:  red;\n    border-radius: 5px;\n    padding: 10px;\n    color: var(--white)\n}\n\n\nsmall {\n    margin-top: 10px;\n    color: red;\n    display: none;\n}\n\n.errorText {\n    margin-top: 5px;\n    color: red;\n}\n\n::-webkit-calendar-picker-indicator{\n    background-color: var(--navy);\n    \n}\n\n\n\n@media (max-width: 767px) {\n    header {\n        justify-content: center;\n        /* padding: 30px; */\n    }\n\n    .logo p{\n        color: var(--white)\n    }\n    \n    .main_container {\n        height: 100vh;\n    }\n\n    .container {\n        display: flex;\n        flex-direction: column;\n        \n    }\n\n    .nav-project {\n        display: none;\n    }\n\n    .add-project-bar span{\n        margin-left: 7px;\n    }\n}\n\n", "",{"version":3,"sources":["webpack://./src/styles/main.css"],"names":[],"mappings":"AAAA;IACI,eAAe;IACf,uBAAuB;IACvB,eAAe;IACf,gBAAgB;IAChB,kBAAkB;IAClB,qBAAqB;AACzB;AACA;;;;IAII,aAAa;AACjB;;AAEA;IACI,sBAAsB;IACtB,SAAS;IACT,UAAU;IACV,uBAAuB;AAC3B;;AAEA;IACI,WAAW;IACX,WAAW;IACX,6BAA6B;IAC7B,mBAAmB;IACnB,aAAa;IACb,mBAAmB;IACnB,aAAa;AACjB;;AAEA;IACI,aAAa;IACb,mBAAmB;AACvB;;AAEA;IACI,eAAe;AACnB;AACA;IACI,iBAAiB;AACrB;AACA;IACI,YAAY;IACZ,aAAa;IACb,gCAAgC;IAChC,sBAAsB;;AAE1B;;AAEA,cAAc;AACd;IACI,yBAAyB;IACzB,kBAAkB;AACtB;;AAEA;IACI,gBAAgB;AACpB;;AAEA;IACI,cAAc;IACd,eAAe;IACf,mBAAmB;IACnB,YAAY;IACZ,eAAe;AACnB;;AAEA;IACI,yBAAyB;IACzB,WAAW;IACX,kBAAkB;AACtB;;AAEA;IACI,sBAAsB;AAC1B;AACA;IACI,gBAAgB;AACpB;;AAEA;IACI,aAAa;IACb,8BAA8B;IAC9B,mBAAmB;IACnB,eAAe;IACf,gBAAgB;IAChB,mBAAmB;IACnB,eAAe;IACf;AACJ;AACA;IACI,aAAa;;AAEjB;;AAEA;IACI,YAAY;IACZ,WAAW;IACX,gBAAgB;IAChB,wBAAwB;AAC5B;AACA;IACI,kBAAkB;IAClB,WAAW;IACX,WAAW;IACX,YAAY;IACZ,0BAA0B;IAC1B,2BAA2B;IAC3B,yBAAyB;IACzB,0BAA0B;AAC9B;AACA;IACI,0BAA0B;IAC1B,0BAA0B;AAC9B;;AAEA;IACI,gBAAgB;IAChB,eAAe;AACnB;;AAEA;IACI,kBAAkB;IAClB,UAAU;IACV,6BAA6B;AACjC;;AAEA;IACI,mBAAmB;IACnB,YAAY;IACZ,UAAU;AACd;;AAEA;IACI,gBAAgB;IAChB,mBAAmB;IACnB,eAAe;IACf,YAAY;IACZ,aAAa;;IAEb,mBAAmB;IACnB,kBAAkB;AACtB;;AAEA;IACI,kBAAkB;IAClB,MAAM;IACN,QAAQ;IACR,oBAAoB;;;AAGxB;;AAEA;IACI,0CAA0C;IAC1C,YAAY;IACZ,qBAAqB;IACrB,UAAU;IACV,eAAe;;IAEf,4BAA4B;AAChC;;AAEA;;;IAGI,yBAAyB;IACzB,WAAW;IACX,kBAAkB;AACtB;;AAEA;IACI,yBAAyB;IACzB,WAAW;IACX,kBAAkB;AACtB;;;AAGA,kCAAkC;AAClC;IACI,aAAa;IACb,eAAe;IACf,UAAU;IACV,OAAO;IACP,MAAM;IACN,WAAW;IACX,YAAY;IACZ,cAAc;IACd,8BAA8B;IAC9B,mCAAmC;IACnC,iBAAiB;AACrB;;AAEA;IACI,YAAY;IACZ,wBAAwB;IACxB,sBAAsB;IACtB,6BAA6B;IAC7B,mBAAmB;IACnB,YAAY;IACZ,mBAAmB;AACvB;;AAEA;IACI,eAAe;IACf,aAAa;AACjB;;AAEA;IACI,aAAa;IACb,aAAa;IACb,sBAAsB;AAC1B;;AAEA;IACI,aAAa;AACjB;AACA;IACI,wBAAwB;IACxB,6BAA6B;IAC7B,iBAAiB;IACjB,0BAA0B;IAC1B,kBAAkB;IAClB,aAAa;IACb;AACJ;;AAEA;IACI,qCAAqC;AACzC;;AAEA;IACI,aAAa;IACb,aAAa;IACb,oBAAoB;IACpB,wBAAwB;AAC5B;;AAEA;IACI,iBAAiB;IACjB,WAAW;IACX,kBAAkB;IAClB,mBAAmB;IACnB,gBAAgB;IAChB,eAAe;;AAEnB;AACA;IACI,mCAAmC;IACnC,kBAAkB;AACtB;;AAEA;IACI,gCAAgC;;AAEpC;;AAEA,kBAAkB;AAClB;IACI,6BAA6B;IAC7B,WAAW;AACf;;AAEA;IACI,UAAU;IACV,aAAa;IACb,sBAAsB;IACtB,uBAAuB;IACvB,iBAAiB;AACrB;AACA;IACI,WAAW;AACf;AACA;IACI,mBAAmB;IACnB,eAAe;AACnB;;AAEA;IACI,aAAa;IACb,cAAc;IACd,aAAa;IACb,mBAAmB;IACnB,2BAA2B;IAC3B,eAAe;;AAEnB;;AAEA;IACI,qBAAqB;IACrB,cAAc;IACd,WAAW;IACX,YAAY;AAChB;;AAEA;IACI,YAAY;IACZ,aAAa;AACjB;;AAEA;IACI,cAAc;AAClB;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,aAAa;AACjB;AACA;IACI,UAAU;IACV,cAAc;AAClB;;AAEA;IACI,gBAAgB;IAChB,0BAA0B;IAC1B,eAAe;AACnB;;AAEA,iBAAiB;AACjB;IACI,6BAA6B;AACjC;;AAEA;IACI,YAAY;AAChB;;AAEA;IACI,YAAY;AAChB;;AAEA,iBAAiB;AACjB;IACI,cAAc;IACd,eAAe;IACf,UAAU;IACV,OAAO;IACP,MAAM;IACN,WAAW;IACX,YAAY;IACZ,cAAc;IACd,8BAA8B;IAC9B,mCAAmC;IACnC,iBAAiB;AACrB;;AAEA;IACI,YAAY;IACZ,yBAAyB;IACzB,sBAAsB;IACtB,6BAA6B;IAC7B,mBAAmB;IACnB,YAAY;IACZ,mBAAmB;IACnB,aAAa;AACjB;;AAEA;IACI,mBAAmB;IACnB,qBAAqB;AACzB;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,kBAAkB;IAClB,yBAAyB;AAC7B;;;;AAIA,kBAAkB;AAClB;IACI;AACJ;;AAEA;IACI,iCAAiC;IACjC,SAAS;IACT,eAAe;IACf,iBAAiB;IACjB,aAAa;AACjB;;AAEA;IACI,iBAAiB;AACrB;;AAEA;IACI,aAAa;AACjB;AACA;IACI,aAAa;AACjB;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,cAAc;AAClB;;AAEA;IACI,wBAAwB;IACxB,aAAa;IACb,6BAA6B;IAC7B,iBAAiB;IACjB,0BAA0B;IAC1B,kBAAkB;IAClB,aAAa;IACb,mBAAmB;IACnB,YAAY;AAChB;;AAEA;IACI,wBAAwB;IACxB,6BAA6B;IAC7B,iBAAiB;IACjB,kBAAkB;IAClB,kBAAkB;IAClB,aAAa;IACb;AACJ;;;AAGA;IACI,gBAAgB;IAChB,UAAU;IACV,aAAa;AACjB;;AAEA;IACI,eAAe;IACf,UAAU;AACd;;AAEA;IACI,6BAA6B;;AAEjC;;;;AAIA;IACI;QACI,uBAAuB;QACvB,mBAAmB;IACvB;;IAEA;QACI;IACJ;;IAEA;QACI,aAAa;IACjB;;IAEA;QACI,aAAa;QACb,sBAAsB;;IAE1B;;IAEA;QACI,aAAa;IACjB;;IAEA;QACI,gBAAgB;IACpB;AACJ","sourcesContent":[":root {\n    --navy: #404258;\n    --lower_navy: #404258F3;\n    --gray: #474E68;\n    --white: #ffffff;\n    --btn_add: #de4c4a;\n    --btn_cancel: #292929;\n}\ninput:focus,\nselect:focus,\ntextarea:focus,\nbutton:focus {\n    outline: none;\n}\n\n* {\n    box-sizing: border-box;\n    margin: 0;\n    padding: 0;\n    font-family: sans-serif;\n}\n\nheader {\n    width: 100%;\n    height: 5vh;\n    background-color: var(--navy);\n    color: var(--white);\n    display: flex;\n    align-items: center;\n    padding: 20px;\n}\n\n.logo {\n    display: flex;\n    align-items: center;\n}\n\n.logo p {\n    font-size: 26px;\n}\n.logo img {\n    margin-left: 10px;\n}\n.container {\n    height: 95vh;\n    display: grid;\n    grid-template-columns: 305px 1fr;\n    grid-auto-flow: column;\n    \n}\n\n/* LEFT MENU */\n.left_menu {\n    background-color: #3e4058;\n    padding: 30px 20px;\n}\n\n.nav {\n    list-style: none;\n}\n\n.nav li{\n    margin: 10px 0;\n    font-size: 16px;\n    color: var(--white);\n    padding: 6px;\n    cursor: pointer;\n}\n\n.nav li:hover{\n    background-color: #42445e;\n    border: 3px;\n    border-radius: 5px;\n}\n\n.nav li img {\n    vertical-align: middle;\n}\n.nav li span {\n    margin-left: 4px;\n}\n\n.add-project-bar {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    font-size: 16px;\n    margin-top: 30px;\n    margin-bottom: 10px;\n    cursor: pointer;\n    color: var(--white)\n}\n.project-btns {\n    display: flex;\n    \n}\n\n.arrow {\n    height: 16px;\n    width: 16px;\n    padding-top: 2px;\n    margin: 0px 3px 0px 15px;\n}\n.arrow::before{\n    position: absolute;\n    content: '';\n    width: 10px;\n    height: 10px;\n    border-top: 2px solid #000;\n    border-left: 2px solid #000;\n    transform: rotate(-45deg);\n    transition: transform .25s;\n}\n.arrow.down::before {\n    transform: rotate(-135deg);\n    transition: transform .25s;\n}\n\n.project_menu ul {\n    list-style: none;\n    cursor: pointer;\n}\n\n.nav-project {\n    visibility: hidden;\n    opacity: 0;\n    transition: opacity 5s linear;\n} \n\n.dropdown {\n    visibility: visible;\n    cursor: none;\n    opacity: 1;\n}\n\n.nav-project li, .dropdown li{\n    margin-left: 9px;\n    color: var(--white);\n    font-size: 16px;\n    padding: 5px;\n    display: flex;\n    \n    align-items: center;\n    position: relative;\n}\n\n.project-delete {\n    position: absolute;\n    top: 0;\n    right: 0;\n    margin: 10px 5px 0 0;\n    \n    \n}\n\n.nav-project li, .dropdown li::before {\n    /* content: url(\"../assets/bullet.png\"); */\n    content: \"•\";\n    display: inline-block; \n    width: 1em;\n    font-size: 24px;\n    \n    /* background-color: aqua; */\n}\n\n.nav-project li:hover, \n.dropdown li:hover\n{\n    background-color: #42445e;\n    border: 3px;\n    border-radius: 5px;\n}\n\n.active{\n    background-color: #42445e;\n    border: 3px;\n    border-radius: 5px;\n}\n\n\n/* Project Form after on click + */\n.modal {\n    display: none;\n    position: fixed;\n    z-index: 1;\n    left: 0;\n    top: 0;\n    width: 100%;\n    height: 100%;\n    overflow: auto;\n    background-color: rgb(0, 0, 0);\n    background-color: rgb(0, 0, 0, 0.4);\n    padding-top: 60px;\n}\n\n.modal-content {\n    width: 450px;\n    margin: 5% auto 15% auto;\n    border: 1px solid #000;\n    background-color: var(--navy);\n    color: var(--white);\n    border: 10px;\n    border-radius: 10px;\n}\n\n.projectHeader {\n    font-size: 12px;\n    padding: 15px;\n}\n\n.projectContent {\n    padding: 15px;\n    display: flex;\n    flex-direction: column;\n}\n\n.projectContent span {\n    margin: 5px 0;\n}\n.inputForm, select {\n    width: calc(100% - 12px);\n    background-color: var(--navy);\n    border: 2px solid;\n    border-color:  var(--gray);\n    border-radius: 5px;\n    padding: 10px;\n    color: var(--white)\n}\n\nhr {\n    border-bottom: 1px solid var(--white);\n}\n\n.btn_container {\n    padding: 15px;\n    display: flex;\n    justify-content: end;\n    width: calc(100% - 12px);\n}\n\n.btn-cancel, .btn-submit {\n    padding: 5px 10px;\n    border: 0px;\n    border-radius: 3px;\n    color: var(--white);\n    font-weight: 600;\n    cursor: pointer;\n    \n}\n.btn-cancel {\n    background-color: var(--btn_cancel);\n    margin-right: 10px;\n}\n\n.btn-submit {\n    background-color: var(--btn_add);\n    \n}\n\n/* RIGHT CONTENT */\n.main_container {\n    background-color: var(--gray);\n    width: 100%;\n}\n\n.view_content {\n    width: 65%;\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    margin: 43px auto;\n}\n#mainHeader {\n    color: #fff;\n}\n.TaskList {\n    color: var(--white);\n    font-size: 16px;\n}\n\n.taskBox {\n    padding: 10px;\n    margin: 10px 0;\n    display: flex;\n    align-items: center;\n    border-left: 5px solid #fff;\n    font-size: 14px;\n    \n}\n\n.taskCheck input[type=\"checkbox\"]{\n    background-color: red;\n    display: block; \n    width: 30px;\n    height: 14px;   \n}\n\n.taskName {\n    flex-grow: 2;\n    margin: 0 5px;\n}\n\n.taskDueDate{\n    margin: 0 10px;\n}\n\n.taskDescription {\n    margin: 0 5px;\n}\n\n.taskEdit {\n    margin: 0 5px;\n}\n.taskRemove {\n    color: red;\n    margin: 0 10px;\n}\n\n.taskRemove:hover, .taskEdit:hover{\n    transition: 0.8s;\n    mix-blend-mode: soft-light;\n    cursor: pointer;\n}\n\n/* Task Checked */\n.checked > .taskName, .checked > .taskDueDate{\n    text-decoration: line-through;\n}\n\n.checked > .taskEdit img, .checked > .taskRemove{\n    opacity: 0.3;\n}\n\n.checked > .taskEdit img:hover, .checked > .taskRemove:hover{\n    opacity: 0.9;\n}\n\n/* Task Details */\n.taskDetailsModal {\n    display: block;\n    position: fixed;\n    z-index: 1;\n    left: 0;\n    top: 0;\n    width: 100%;\n    height: 100%;\n    overflow: auto;\n    background-color: rgb(0, 0, 0);\n    background-color: rgb(0, 0, 0, 0.4);\n    padding-top: 60px;\n}\n\n.taskDetails {\n    width: 450px;\n    margin: 15% auto 15% auto;\n    border: 1px solid #000;\n    background-color: var(--navy);\n    color: var(--white);\n    border: 10px;\n    border-radius: 10px;\n    padding: 30px;\n}\n\n.taskDetailsName {\n    margin-bottom: 10px;\n    word-wrap: break-word;\n}\n\n.taskDetailsDuedate {\n    margin: 5px 0;\n}\n\n.taskDetailsPriority {\n    margin: 5px 0;\n}\n\n.taskDetailsDescription{\n    inline-size: 150px;\n    overflow-wrap: break-word;\n}\n\n\n\n/* Inbox Content */\n.inbox {\n    color: var(--white)\n}\n\n.add_task_btn {\n    background-color: rgb(0, 0, 0, 0);\n    border: 0;\n    cursor: pointer;\n    margin: 20px 10px;\n    display: flex;\n}\n\n.add_task_btn span {\n    margin-left: 10px;\n}\n\n.weekContainer {\n    display: none;\n}\n.inboxContainer {\n    display: none;\n}\n\n.hideContainer {\n    display: none;\n}\n\n.showContainer {\n    display: block;\n}\n\n.textAreaForm {\n    width: calc(100% - 12px);\n    height: 150px;\n    background-color: var(--navy);\n    border: 2px solid;\n    border-color:  var(--gray);\n    border-radius: 5px;\n    padding: 10px;\n    color: var(--white);\n    resize: none;\n}\n\n.error {\n    width: calc(100% - 12px);\n    background-color: var(--navy);\n    border: 2px solid;\n    border-color:  red;\n    border-radius: 5px;\n    padding: 10px;\n    color: var(--white)\n}\n\n\nsmall {\n    margin-top: 10px;\n    color: red;\n    display: none;\n}\n\n.errorText {\n    margin-top: 5px;\n    color: red;\n}\n\n::-webkit-calendar-picker-indicator{\n    background-color: var(--navy);\n    \n}\n\n\n\n@media (max-width: 767px) {\n    header {\n        justify-content: center;\n        /* padding: 30px; */\n    }\n\n    .logo p{\n        color: var(--white)\n    }\n    \n    .main_container {\n        height: 100vh;\n    }\n\n    .container {\n        display: flex;\n        flex-direction: column;\n        \n    }\n\n    .nav-project {\n        display: none;\n    }\n\n    .add-project-bar span{\n        margin-left: 7px;\n    }\n}\n\n"],"sourceRoot":""}]);
// Exports
    ...
    return function ProjectList() {
        ...
        this.updateWeekProject = () => {
            ...
            this.projects.forEach((project) => {
                ...
                ((task) => {
                    let date = new Date(task.getDueDate())
                    let isDateThisWeek = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(date, new Date(), {weekStartsOn: 1})
...
const app = (() => {
    ...
    function loadHomePage() {
        ...
        formProject.init()
        formTask.init()
        _Storage__WEBPACK_IMPORTED_MODULE_0__["default"].addProject(new _Project__WEBPACK_IMPORTED_MODULE_1__["default"]("Today"))
        // load projects
        _Storage__WEBPACK_IMPORTED_MODULE_0__["default"].getProjectsList().projects.forEach((project) => {
    ...
    function handleFormEditSubmit(e, oldTask){
        ...
        const editedTask = new _Task__WEBPACK_IMPORTED_MODULE_2__["default"]({
            name: editTaskName,
        ...
        if (isFormValid)
        {
            if (projectName === "Today" || projectName === "Week")
            {
                ...
                _Storage__WEBPACK_IMPORTED_MODULE_0__["default"].updateTask(taskProjectName, oldTaskName, editedTask)
            }
                
            _Storage__WEBPACK_IMPORTED_MODULE_0__["default"].updateTask(projectName, oldTaskName, editedTask)
    ...
    function checkEditTaskName(newTaskName, oldTaskName, projectName, taskNameInput) {
        ...
        const todoList = _Storage__WEBPACK_IMPORTED_MODULE_0__["default"].getProjectsList()
    ...
    function handleTaskBtn(e) {
        ...
        let task = _Storage__WEBPACK_IMPORTED_MODULE_0__["default"].getProjectsList().getProject(projectName).getTask(taskName)
    ...
    function handleTaskCheckBtn(e){
        ...
        {   
            if (projectName === "Today" || projectName === "Week")
            {
                ...
                _Storage__WEBPACK_IMPORTED_MODULE_0__["default"].checkTask(taskProjectName, taskName, true)
            }
            _Storage__WEBPACK_IMPORTED_MODULE_0__["default"].checkTask(projectName, taskName, true)
        }
        else {
            if (projectName === "Today" || projectName === "Week")
            {
                let taskProjectName = taskBtn.getAttribute("data-projectname")
                _Storage__WEBPACK_IMPORTED_MODULE_0__["default"].checkTask(taskProjectName, taskName, false)
            }
            _Storage__WEBPACK_IMPORTED_MODULE_0__["default"].checkTask(projectName, taskName, false)
        } 
    ...
    function handleTaskRemoveBtn(e)
    {
        ...
        if (projectName === "Today" || projectName === "Week")
        {
            _Storage__WEBPACK_IMPORTED_MODULE_0__["default"].deleteTask(taskBtn.getAttribute("data-projectname"), taskName)
        }    
    ...
    function openToday()
    {   
        _Storage__WEBPACK_IMPORTED_MODULE_0__["default"].getTodayProjects()
        openProject("Today", this)
    }

    function openWeek()
    {
        _Storage__WEBPACK_IMPORTED_MODULE_0__["default"].getWeekProject()
    ...
    function loadTasks(projectName){
        ...
        _Storage__WEBPACK_IMPORTED_MODULE_0__["default"].getProjectsList()
        ...
        `
            <div class="taskBox ${checked}" data-projectName = "${projectName}" >
                ...
                <div class="taskDueDate">
                    ${(0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(task.duedate), "MMM do")}
                </div>
                
                <div class="taskEdit">
                    <img src="${__webpack_require__(/*! ./assets/edit.png */ "./src/assets/edit.png")}" alt="" >
                </div>
                <div class="taskRemove">
                    <img src="${__webpack_require__(/*! ./assets/delete16.png */ "./src/assets/delete16.png")}" alt="" >
                </div>
    ...
    function handleTaskFormProjectSelect()
    {
        ...
        const projects = _Storage__WEBPACK_IMPORTED_MODULE_0__["default"].getProjectsList().getProjects();
    ...
    function insertProject(projectName) {
        ...
        deleteImg.src = __webpack_require__(/*! ./assets/delete16.png */ "./src/assets/delete16.png")
...
/***/ "./src/assets/delete16.png":
/*!*********************************!*\
  !*** ./src/assets/delete16.png ***!
  \*********************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "delete16.png";
